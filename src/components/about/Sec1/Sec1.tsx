          ...
          <div className="row d-flex no-gutters">
            ...
            <div className="col-md-7 pl-md-5 py-md-5">
              <div className="heading-section pt-md-5 mb-4">
                <h2 className="mb-2">{text[0]?.value ?? "Welcome Pressure Washing"}</h2>
                <p>
                  {text[1]?.value ?? "A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth."}
                </p>
              </div>
              <div className="row">
                <div className="col-md-6 services-2 w-100 d-flex">
                  ...
                  <div className="text pl-3">
                    <h4>{text[2]?.value ?? "50 Years of Service"}</h4>
                    <p>{text[3]?.value ?? "Far far away, behind the word mountains, far from the countries."}</p>
                  </div>
                </div>
                <div className="col-md-6 services-2 w-100 d-flex">
                  <div className="icon d-flex align-items-center justify-content-center">
                  ...
                  <div className="text pl-3">
                    <h4>{text[4]?.value ?? "Professional & Experienced Staff"}</h4>
                    <p>{text[5]?.value ?? "Far far away, behind the word mountains, far from the countries."}</p>
                  </div>
                </div>
                <div className="col-md-6 services-2 w-100 d-flex">
                  <div className="icon d-flex align-items-center justify-content-center">
                  ...
                  <div className="text pl-3">
                    <h4>{text[6]?.value ?? "High Quality & Reliable Service"}</h4>
                    <p>{text[7]?.value ?? "Far far away, behind the word mountains, far from the countries."}</p>
                  </div>
                </div>
                <div className="col-md-6 services-2 w-100 d-flex">
                  <div className="icon d-flex align-items-center justify-content-center">
                  ...
                  <div className="text pl-3">
                    <h4>{text[8]?.value ?? "Customer Service & Expert Advice"}</h4>
                    <p>{text[9]?.value ?? "Far far away, behind the word mountains, far from the countries."}</p>
                  </div>
                </div>
              </div>
            </div>
