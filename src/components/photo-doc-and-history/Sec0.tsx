...
const FEATURES: Feature[] = [
  {
    key: "timestamps",
    icon: "🕒",
    title: "Auto-Timestamped Photos",
    desc:
      "Store image metadata in Firestore (jobId, timestamp, type: “before/after”).",
  },
  {
    key: "portal",
    icon: "🗂️",
    title: "Client Portal",
    desc:
      "Route /client-portal/:clientId shows quotes, images, and signed docs for each customer.",
  },
  {
    key: "team",
    icon: "👥",
    title: "Team Access",
    desc:
      "Role-based access: crew members see their assigned scopes and required photo evidence.",
  },
];

const APP_HREF = "/photodocsandhistory"; // entry route for this app
...
const Sec0: React.FC = () => {
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row no-gutters slider-text align-items-end">
            <div className="col-md-9 ftco-animate pb-5" data-animate-effect="fadeInUp">
              ...
              <h1 className="mb-0 bread">Photo Documentation + Job History</h1>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Content */}
      <section style={s.section} aria-label="Photo Documentation and Job History features">
        <header style={s.header}>
          <div style={s.headerLeft}>
            <span aria-hidden="true" style={{ fontSize: 22 }}>📸</span>
            <div>
              <h2 style={s.h2}>Photo Documentation + Job History</h2>
        ...
        <div style={s.footer}>
          ...
          <code style={s.code}>JobGalleryCard</code> +{" "}
          <code style={s.code}>ClientPortalScreen</code>.
        </div>
      </section>
    </>
  );
