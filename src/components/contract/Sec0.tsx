...
const FEATURES: Feature[] = [
  {
    key: "sow",
    icon: "📝",
    title: "Auto-Insert Scope of Work",
    desc:
      "Build from detected areas and selected services. Auto-fill paragraphs using GPT prompt templates (Echo).",
  },
  {
    key: "esign",
    icon: "✍️",
    title: "E-sign",
    desc:
      "Use Firebase with SignRequest or DocuSign embedded signing for fast, compliant signatures.",
  },
  {
    key: "clauses",
    icon: "📚",
    title: "Legal Clauses",
    desc:
      "Store clause templates in Firestore. Let the user toggle standard options (e.g., insurance waiver, delay fee).",
  },
  {
    key: "deposit",
    icon: "💳",
    ...
    desc:
      "Integrate with Stripe Checkout or PayPal Buttons. Collect deposits via fixed amount or percentage.",
  },
];

const APP_HREF = "/contract"; // update if your entry route differs
...
const Sec0: React.FC = () => {
  ...
  // optional: same ftco-animate mimic used in prior sections
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row no-gutters slider-text align-items-end">
            <div className="col-md-9 ftco-animate pb-5" data-animate-effect="fadeInUp">
              ...
              <h1 className="mb-0 bread">Smart Contract Builder</h1>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Content */}
      <section style={s.section} aria-label="Smart Contract Builder features">
        <header style={s.header}>
          <div style={s.headerLeft}>
            <span aria-hidden="true" style={{ fontSize: 22 }}>📃</span>
            <div>
              <h2 style={s.h2}>Smart Contract Builder</h2>
        ...
        <div style={s.footer}>
          ...
          <code style={s.code}>ContractBuilderCard</code> +{" "}
          <code style={s.code}>contractPreview()</code> PDF generator.
        </div>
      </section>
    </>
  );
