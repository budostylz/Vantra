...
const GlobalFtcoLoader2: React.FC = () => {
  // Overlay wiring (auto-injected)
  const ROUTE = "global";
  const OVERLAY_KEY = "globalFtcoLoader2";
  const { node: globalFtcoLoader2Overlay, text, links, images, variables } = useOverlay(ROUTE, OVERLAY_KEY);
...
export default GlobalFtcoLoader2;