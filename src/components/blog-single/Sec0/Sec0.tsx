          ...
          <div className="row no-gutters slider-text align-items-end">
            <div className="col-md-9 ftco-animate pb-5" data-animate-effect="fadeInUp">
              <p className="breadcrumbs mb-2">
                ...
                <span className="mr-2">
                  <a href={links[1]?.href ?? "blog.html"}>
                    {links[1]?.text ?? "Blog"} <i className="ion-ios-arrow-forward"></i>
                  </a>
                </span>
                <span>
                  {text[2]?.value ?? "Blog Single"} <i className="ion-ios-arrow-forward"></i>
                </span>
              </p>
              <h1 className="mb-0 bread">{text[3]?.value ?? "Blog Details"}</h1>
            </div>
          </div>
        </div>
      </section>
