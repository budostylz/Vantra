...
const FEATURES: Feature[] = [
  {
    key: "preview",
    icon: "🧾",
    title: "Instant Proposal Preview",
    desc:
      "Show generated PDF preview using react-pdf or a Firestore HTML snapshot. Include photos, quote items, line-by-line pricing, and tax.",
  },
  {
    key: "sendnow",
    icon: "📤",
    title: "Send Now Feature",
    desc:
      "Use EmailJS or a Firebase Function (SendGrid API) to email or SMS the PDF. Include branded header/footer and a quote number.",
  },
  {
    key: "expiry",
    icon: "⏳",
    title: "Quote Expiry Timer",
    desc:
      "Store expiryTimestamp in Firestore and show a countdown UI on the quote page to encourage timely acceptance.",
  },
];

const APP_HREF = "/generator";
...
const Sec0: React.FC = () => {
  ...
  // optional: same ftco-animate mimic you used previously
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row no-gutters slider-text align-items-end">
            <div className="col-md-9 ftco-animate pb-5" data-animate-effect="fadeInUp">
              ...
              <h1 className="mb-0 bread">Real-Time Quote Generator</h1>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Content */}
      <section style={s.section} aria-label="Real-Time Quote Generator features">
        <header style={s.header}>
          <div style={s.headerLeft}>
            <span aria-hidden="true" style={{ fontSize: 22 }}>🧾</span>
            <div>
              <h2 style={s.h2}>Real-Time Quote Generator</h2>
        ...
        <div style={s.footer}>
          ...
          <code style={s.code}>QuoteGeneratorCard</code> +{" "}
          <code style={s.code}>sendQuoteToClient()</code> function.
        </div>
      </section>
    </>
  );
