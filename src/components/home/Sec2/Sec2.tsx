...
export default function Sec2() {
  ...
  return (
    <>
      <section className="ftco-section ftco-intro" style={{ backgroundImage: `url(${images[0]?.src ?? 'https://storage.googleapis.com/budoapps-5aacf.firebasestorage.app/templates/pressurewashing-3365cccdb5/images/bg_2.jpg'})` }}>
