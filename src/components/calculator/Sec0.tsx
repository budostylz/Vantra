...
const FEATURES: Feature[] = [
  {
    key: "profiles",
    icon: "🗂️",
    title: "Pre-Set Pricing Profiles",
    desc:
      "Store price per sq. ft. by service in Firestore (e.g., pricing_profiles/{profileId}). Allow switching via an admin panel.",
  },
  {
    key: "addons",
    icon: "➕",
    title: "Add-On Detection",
    desc:
      "Trigger upsells based on detected tags (e.g., overspray ⇒ recommend adhesive removal). Echo AI can handle upsell copy.",
  },
  {
    key: "labor",
    icon: "⏱️",
    title: "Labor & Time Calculator",
    desc:
      "Heuristic rules: sqft ÷ avg productivity per tech + job-type modifier. Store per-service productivity rates.",
  },
  {
    key: "travel",
    icon: "🗺️",
    title: "Travel / Zone Fee",
    desc:
      "Use user geo-coordinates to map to a zone and auto-apply surcharge from a zone_pricing collection.",
  },
];

const APP_HREF = "/calculator"; // entry route for the calculator app
...
const Sec0: React.FC = () => {
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row no-gutters slider-text align-items-end">
            <div className="col-md-9 ftco-animate pb-5" data-animate-effect="fadeInUp">
              ...
              <h1 className="mb-0 bread">On-Site Pricing Calculator</h1>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Content */}
      <section style={s.section} aria-label="On-Site Pricing Calculator features">
        <header style={s.header}>
          <div style={s.headerLeft}>
            <span aria-hidden="true" style={{ fontSize: 22 }}>💰</span>
            <div>
              <h2 style={s.h2}>On-Site Pricing Calculator</h2>
        ...
        <div style={s.footer}>
          ...
          <code style={s.code}>PricingCalculatorService</code> function +{" "}
          <em>editable admin interface</em>.
        </div>
      </section>
    </>
  );
