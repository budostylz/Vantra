  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: `url("https://storage.googleapis.com/budoapps-5aacf.firebasestorage.app/users/GLelFyrkvyMnLPTfOFY2xS6QT3t2/vantra-qSKe8jlhMtNvudBqrdmcYljQMM42/img/pexels-tatsuo-nakamura-2149208499-33945198.jpg")`,
        }}
          ...
          <div className="row no-gutters slider-text align-items-end">
            <div className="col-md-9 ftco-animate pb-5" data-animate-effect="fadeInUp">
              <p className="breadcrumbs mb-2">
                ...
                <span>
                  {/*text[1]?.value ??*/ "Janitorial Office Cleaning Service Quote"} <i className="ion-ios-arrow-forward"></i>
                </span>
              </p>
              <h1 className="mb-0 bread">{/*text[2]?.value ??*/ "Janitorial Office Cleaning Service Quote"}</h1>
            </div>
          </div>
        </div>
      </section>
