...
const FEATURES: Feature[] = [
  {
    key: "profile",
    icon: "🗃️",
    title: "Client Profile Build-Out",
    desc:
      "Create clients/{clientId} on first job scan. Populate name, location, building type, and preferences.",
  },
  {
    key: "followups",
    icon: "🔔",
    ...
    desc:
      "Scheduled Cloud Function runs X days after job completion. Use Echo to generate personalized follow-up messages.",
  },
  {
    key: "repeat",
    icon: "📈",
    title: "Repeat Job Estimator",
    desc:
      "Pull last jobId from client profile and reapply sqft/time/labor with an inflation adjustment.",
  },
];
...
const Sec0: React.FC = () => {
  ...
  // optional: ftco-animate mimic (same as prior sections)
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row no-gutters slider-text align-items-end">
            <div className="col-md-9 ftco-animate pb-5" data-animate-effect="fadeInUp">
              ...
              <h1 className="mb-0 bread">AI-Driven CRM</h1>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Content */}
      <section style={s.section} aria-label="AI-Driven CRM features">
        <header style={s.header}>
          <div style={s.headerLeft}>
            <span aria-hidden="true" style={{ fontSize: 22 }}>🧠</span>
            <div>
              <h2 style={s.h2}>AI-Driven CRM</h2>
        ...
        <div style={s.footer}>
          ...
          <code style={s.code}>CRMService</code> (Firestore triggers + prompt generator).
        </div>
      </section>
    </>
  );
